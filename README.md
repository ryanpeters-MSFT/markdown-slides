...
A simple static app that renders Markdown files as slide decks.
...
4. Press F or F11 to toggle fullscreen.
5. In fullscreen, scroll vertically (mouse wheel/trackpad) for long slides.

## Slide format

- Use `---` on its own line to split slides inside a single file.
